...
- Export keys
  ```ps1
  # Public key
  gpg --output cwel-public-gpg-key.pgp --armor --export trannguyenthaibinh46@gmail.com
  # Secret key
  gpg --output cwel-secret-gpg-key.pgp --armor --export-secret-key trannguyenthaibinh46@gmail.com
  ```
...
> [!NOTE]
>
> go to https://github.com/cwelsys/linux-dotfiles#browser
...
```pwsh
C:\Users\cwel\scoop\apps\pwsh\current\install-file-context.reg
C:\Users\cwel\scoop\apps\pwsh\current\install-explorer-context.reg
```
...
| **VARIABLE**        | **PATH**                           |
| ------------------- | ---------------------------------- |
| `APPDATA`           | `C:\Users\cwel\AppData\Roaming`    |
| `HOMEDRIVE`         | `C:`                               |
| `USERPROFILE`       | `C:\Users\cwel`                    |
| `HOMEPATH`          | `\Users\cwel`                      |
| `LOCALAPPDATA`      | `C:\Users\cwel\AppData\Local`      |
| `PROGRAMDATA`       | `C:\ProgramData`                   |
| `PROGRAMFILES`      | `C:\Program Files`                 |
| `PROGRAMFILES(X86)` | `C:\Program Files (x86)`           |
| `SYSTEMROOT`        | `C:\Windows`                       |
| `TEMP` & `TMP`      | `C:\Users\cwel\AppData\Local\Temp` |
