...
-- Copy from catppuccin-mocha.lua and make your tweaks
M.scheme = {
  background = "#1E1E2E",
  foreground = "#CDD6F4",
  cursor_bg = "#F5E0DC",
  ...
  tab_bar = {
    ...
    active_tab = { bg_color = "#94e2d5", fg_color = "#11111B", italic = false },
...
function M.get()
  return { id = "catppuccin-mocha-custom", label = "Catppuccin Mocha (Custom)" }
end
